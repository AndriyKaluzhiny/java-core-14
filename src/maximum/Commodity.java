...
public class Commodity {
    ...
    public void sortByName(HashSet<Commodity> c) {
        TreeSet<Commodity> ts = new TreeSet<>(new NameComparator());
        ts.addAll(c);
    ...
    public void sortByLength(HashSet<Commodity> c) {
        TreeSet<Commodity> ts = new TreeSet<>(new LengthComparator());
        ts.addAll(c);
    ...
    public void sortByWidth(HashSet<Commodity> c) {
        TreeSet<Commodity> ts = new TreeSet<>(new WidthComparator());
        ts.addAll(c);
    ...
    public void sortByWeight(HashSet<Commodity> c) {
        TreeSet<Commodity> ts = new TreeSet<>(new WeightComparator());
        ts.addAll(c);
